 ...
 * Fetches, filters, sorts, and displays publications
 */
...
async function fetchPublications() {
  try {
    ...
    return data.publications.map(pub => ({
      ...pub,
      thumbnail: pub.thumbnail || './images/publications/default.jpg',
      links: {
...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  try {
    ...
    if (filterParam && ['all', 'medical-imaging', 'gnn', 'generative'].includes(filterParam)) {
